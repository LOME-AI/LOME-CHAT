 ...
 * wording.
 */
export function getPromptPlaceholder(modality: ChatModality | undefined, fallback: string): string {
...
export function getSendAriaLabel(modality: ChatModality | undefined): string {
...
export function getMediaLoadingLabel(modality: ChatModality | undefined): string {
...
export function getInspirationLabel(_modality: ChatModality | undefined): string {
  return 'Need inspiration? Try these:';
}

export function getCostUnit(modality: ChatModality | undefined): string {
