...
export const TEST_IDS = {
  ...
  adminC360Invalid: 'admin-c360-invalid',
  adminC360Panels: 'admin-c360-panels',
  adminJobsTabs: 'admin-jobs-tabs',
  adminJobsTypeFilter: 'admin-jobs-type-filter',
  adminJobsTable: 'admin-jobs-table',
  adminJobsEmpty: 'admin-jobs-empty',
  adminJobsLoadMore: 'admin-jobs-load-more',
  adminJobsRefresh: 'admin-jobs-refresh',
  adminJobExpand: 'admin-job-expand',
  adminJobDetail: 'admin-job-detail',
  adminJobPayload: 'admin-job-payload',
  adminJobErrors: 'admin-job-errors',
  adminJobRedrive: 'admin-job-redrive',
  adminJobDiscard: 'admin-job-discard',
  adminJobRestore: 'admin-job-restore',
  adminModelsFilter: 'admin-models-filter',
  adminModelsTable: 'admin-models-table',
  adminModelsEmpty: 'admin-models-empty',
  adminModelsTruncated: 'admin-models-truncated',
  adminModelsRefresh: 'admin-models-refresh',
  adminModelDisable: 'admin-model-disable',
  adminModelEnable: 'admin-model-enable',
  adminAuditFilters: 'admin-audit-filters',
  adminAuditFilterPill: 'admin-audit-filter-pill',
  adminAuditApplyFilters: 'admin-audit-apply-filters',
  adminAuditInspect: 'admin-audit-inspect',
  adminAuditDrawer: 'admin-audit-drawer',
  adminAuditDrawerRaw: 'admin-audit-drawer-raw',
  adminAuditLoadMore: 'admin-audit-load-more',
  adminAuditEmpty: 'admin-audit-empty',
  adminSqlEditor: 'admin-sql-editor',
  adminSqlRun: 'admin-sql-run',
  adminSqlBadge: 'admin-sql-badge',
  adminSqlResults: 'admin-sql-results',
  adminSqlTruncated: 'admin-sql-truncated',
  adminSqlStatus: 'admin-sql-status',
